...
DM_REDIRECT_TEXT = (
    "Open a private chat with Hermes to access your personal Google Calendar."
)
    ...
    def __init__(
        ...
        *,
        ...
        self._current_redirect: ContextVar[bool] = ContextVar(
            f"calendar_redirect_{id(self)}",
            default=False,
        )
        self._current_gateway_context: ContextVar[bool] = ContextVar(
            f"calendar_gateway_context_{id(self)}",
            default=False,
        )
        self._lock = Lock()
    ...
    def resolve_dm_tool(
        ...
        if runtime_id:
            ...
            if session_key is not None:
                ...
                if caller is None:
                    raise LookupError("Hermes session has no captured gateway caller")
                return caller
